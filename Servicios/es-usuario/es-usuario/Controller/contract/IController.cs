...
namespace es_usuario.Controller.contract
{
    /// <summary>
    ...
    public interface IController
    {
        ...
        Task<ActionResult<object>> Actualizar(UsuarioType EntityType);
        ...
        Task<ActionResult<object>> Guardar(UsuarioType EntityType);
